...
@section('judul_halaman','Add New Doctors')
                ...
                <form class="form-horizontal" action="{{ route('doctor.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_dokter" name="nama_dokter" placeholder="Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sip" class="col-sm-3 text-right control-label col-form-label">SIP</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sip" name="sip" placeholder="No SIP">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="no_telp" class="col-sm-3 text-right control-label col-form-label">Telephone</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="no_telp"  name="no_telp" placeholder="Telephone">
                            </div>
                        </div>
                    </div>
